...
% Save the figure
filepath3 = 'results';
if ~exist(filepath3, 'dir')
    mkdir(filepath3);
end
state_plot(new_cluster_idx);
hFig = gcf;  
save_path = fullfile(filepath3, 'state_transitions_result.png');
print(hFig, save_path, '-dpng', '-r300');
fprintf('Figure saved as PNG in folder: %s\n', filepath3);
